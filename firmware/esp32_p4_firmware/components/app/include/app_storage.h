...
/**
 * @brief Process queued images and save to SD card
 *
 * This function should be called after AI interaction completes.
 * It mounts SD card (if needed) and saves all queued images.
 ...
 *
 * Saves recorded audio to /sdcard/media/audio/REC_YYYYMMDD_HHMMSS.wav.
 * Call after finishing an interaction (opportunistic, non-blocking intent).
 *
